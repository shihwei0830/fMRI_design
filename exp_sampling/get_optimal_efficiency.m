function results = get_optimal_efficiency(n_trials,t_range,tr,mu,n_sim,leave_best,fname)
%
% results = get_optimal_efficiency(40,[2 8;2 20],2,[4 6],20000,5,'exp3')
%
...
for i=1:n_sim
     t_isi(:,i) = get_expo_sample(t_range(1,:),2,mu(1),n_trials);
     t_iti(:,i) = get_expo_sample(t_range(2,:),tr,mu(2),n_trials);
    %t_isi(:,i) = get_expo_sample_representative(t_range(1,:),2,mu(1),n_trials);
    %t_iti(:,i) = get_expo_sample_representative(t_range(2,:),tr,mu(2),n_trials);
end
